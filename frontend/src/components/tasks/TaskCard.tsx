...
const DEFAULT_CARD_FIELDS: Required<TaskCardFields> = {
  priority: true,
  members: true,
  dueDate: true,
  labels: true,
...
export function TaskCard({ task, onClick, fields }: TaskCardProps) {
  const show = { ...DEFAULT_CARD_FIELDS, ...fields };
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          {show.members && task.members.length > 0 && (
          ...
          {show.priority && task.priority !== 'No Priority' && (
